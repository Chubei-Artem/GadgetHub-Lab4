...
// ============================================================================
// 2️⃣ ДОПОМІЖНІ ФУНКЦІЇ (повідомлення, адмін-панель, графіки)
// ============================================================================
...
// ============================================================================
// 3️⃣ ЗАВАНТАЖЕННЯ ДАНИХ З JSON (вимога лабораторної)
// ============================================================================
...
// ============================================================================
// 4️⃣ РЕНДЕР ФУНКЦІЇ (відображення компонентів)
// ============================================================================
...
// ============================================================================
// 5️⃣ АВТОРИЗАЦІЯ: форми, валідація, оновлення інтерфейсу
// ============================================================================
...
// ============================================================================
// 6️⃣ ФІЛЬТРИ: категорія, пошук, ціна, сортування
// ============================================================================
...
// ============================================================================
// 7️⃣ КОШИК: додавання, зміна кількості, видалення
// ============================================================================
...
// ============================================================================
// 8️⃣ АДМІН-ФУНКЦІЇ: CRUD операції (редагувати, видалити, додати)
// ============================================================================
...
// ============================================================================
// 9️⃣ ІНШІ ФУНКЦІЇ: новини, карусель, підписка, реклама, scroll-top
// ============================================================================
...
document.addEventListener("DOMContentLoaded", () => {
  // 🔹 1. Завантажуємо дані з JSON (перший крок!)
  loadData();

  // 🔹 2. Налаштовуємо форми авторизації
  setupAuthForms();

  // 🔹 3. Обробник оформлення замовлення
  document
    .getElementById("checkout-btn")
    ?.addEventListener("click", handleCheckout);

  // 🔹 4. Налаштовуємо фільтри товарів
  setupFilters();

  // 🔹 5. Делегування для кнопок "Додати до кошика"
  ...
  // 🔹 6. Обробники кошика (відкриття/закриття)
